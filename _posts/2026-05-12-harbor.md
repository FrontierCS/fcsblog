...
<div style="text-align: center; margin-bottom: 0;">
  <figure style="margin-bottom: 0;">
    <img src="{{ 'assets/img/2026-03-06-agent-evaluation/evolution.gif' | relative_url }}" style="width: 25%; border-radius: 6px;" alt="Online Evolution on Polyomino Packing">
...
| Metric | Claude Opus 4-7 | Kimi K2.6 |
|---|---:|---:|
| Partial Score | 35.1 | 34.0 |
| Avg. Steps | 83.0 (up to 459) | 56.5 (up to 405) |
| Avg. Turns | 80.8 (up to 456) | 55.7 |
| Avg. Output Tokens | 200K (up to 531K) | 149K |
| Avg. Thinking Calls | — | 56.5 (up to 404) |
| Avg. Tool Calls | 45.0 (up to 291) | 55.7 (up to 405) |
| Zero-Score Tasks | 52 / 105 | 50 / 105 |
| Token Limit Hit | 17 | 8 |
